...
function [Dotau, A, E, f,tau, focus_size, error_sign]=TILT(varargin)
% Version info: v 1.04
% -------------------------------------------------------------------------
...
if args.pyramid==1
    ...
    for scale=total_scale:-1:0
        ...
        tfm=maketform('projective', scale_matrix');
        input_image=imtransform(input_image, tfm, 'bicubic');   %pyramid 后的图像。
        ...
        tau=tau_init;
        [Dotau, A, E, f,tau, error_sign]=tilt_kernel(input_image, center, focus_size, tau,args);
